/** 文件职责：workflow 后端领域：提供聚焦的辅助函数。 */
package org.opengis.automation.workflow;

import java.time.OffsetDateTime;
import java.util.List;
import java.util.Map;
import org.opengis.automation.workflow.model.WorkflowCondition;
import org.opengis.automation.workflow.model.WorkflowDocument;
import org.opengis.automation.workflow.model.WorkflowEdge;
import org.opengis.automation.workflow.model.WorkflowNode;
import org.opengis.automation.workflow.model.WorkflowPort;
import org.opengis.automation.workflow.validation.WorkflowValidator;
