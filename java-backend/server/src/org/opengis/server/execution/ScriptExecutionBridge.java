...
import org.opengis.automation.code.runner.ScriptCallbacks;
...
@Component
public final class ScriptExecutionBridge {
  private final ObjectMapper mapper;
  private volatile ToolRuntime tools;

  public ScriptExecutionBridge(ObjectMapper mapper) {
    this.mapper = mapper;
  }
    ...
    return new ScriptCallbacks() {
      ...
      public Map<String, Object> callTool(String name, Map<String, Object> arguments) {
        ...
        return result.output() == null
            ? Map.of()
            : mapper.convertValue(result.output(), JsonTypeReferences.STRING_OBJECT_MAP);
      }
