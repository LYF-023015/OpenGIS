...
import org.opengis.assistant.provider.ProviderCatalog;
...
@Component
public final class AgentRpcMethods {
  ...
  private Object testConnection(JsonNode params) {
    ...
    try {
      String response =
          ChatClient.create(clients.createChatModel(provider))
  ...
  private static RpcException invalidParams(String message) {
    return new RpcException(org.opengis.core.protocol.JsonRpcErrorCodes.INVALID_PARAMS, message);
  }
}
