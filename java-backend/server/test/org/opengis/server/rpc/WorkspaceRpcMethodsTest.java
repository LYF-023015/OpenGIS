...
class WorkspaceRpcMethodsTest {
  ...
  void setUp() {
    ...
    new WorkspaceRpcMethods(registry, objectMapper).registerMethods();
  ...
  void replacesPersistencePlaceholdersWithFixtureBackedResults() {
    ...
    assertThat(callWithRunId("rpc.runs.get").path("result").path("meta").path("run_id").asString())
