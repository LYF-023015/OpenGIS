/** 文件职责：tool-catalog 前端功能：页面级界面与交互编排。 */
  ...
  const fetchToolAndSkillCatalog = useCallback(async () => {
    ...
    try {
      const [toolResult, userSkillResult] = await Promise.allSettled([
        ...
        backendClient.send("rpc.user_skill.list", {
          ...
          <div className="p-2">
            {filteredUserSkills.length === 0 ? (
              ...
              filteredUserSkills.map((skill) => (
                <div
                  key={skill.name}
                  className="mb-2 rounded-md border border-border/50 bg-bg-secondary/40 p-2"
                >
                  <div className="mb-1 flex items-center gap-2">
                    ...
                    <span className="rounded bg-bg-tertiary px-1.5 py-0.5 text-[9px] text-text-muted">
                      {skill.source}
                    </span>
                  </div>
                  {skill.description && (
                    <p className="mb-1 line-clamp-3 text-[11px] leading-relaxed text-text-secondary">
                      {skill.description}
                    </p>
                  )}
                ...
                {isOpen && (
                  <div className="pb-1">
                    {items.map((skill) => {
                      ...
                      return (
                        <div key={skill.name} className="mx-2 mb-0.5">
                          <button
                            onClick={() =>
                          ...
                          {isSkillOpen && (
                            <div
                              className="px-3 py-2 text-xs text-text-secondary space-y-2
                            ...
                            >
                              ...
                              {skill.params.length > 0 && (
                                <div>
                                  <div className="mb-1 text-[11px] font-semibold text-text-primary uppercase tracking-wide">
                                    {t.skills.params}
                                  </div>
                                  <div className="space-y-1">
                                    {skill.params.map((p) => (
                                      ...
                                      >
                                        ...
                                        <span className="text-[10px] text-text-muted leading-tight flex-1">
                                          {p.description}
                                        </span>
                                      </div>
                                    ))}
                              ...
                              {skill.returns && (
                                <div>
                                  <div className="mb-0.5 text-[11px] font-semibold text-text-primary uppercase tracking-wide">
                                    {t.skills.returns}
                                  </div>
